...
- Instructional text such as `Fill in this section with`, `Document:`, `Suggested categories:`, `If the project is complex`, and similar template guidance should not remain in the final project `CLAUDE.md`.
- Template guidance exists only to help the human or agent draft a project-specific `CLAUDE.md`.
